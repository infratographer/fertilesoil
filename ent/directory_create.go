...
func (dc *DirectoryCreate) SetMetadata(s string) *DirectoryCreate {
	dc.mutation.SetMetadata(s)
	return dc
}

// SetNillableMetadata sets the "metadata" field if the given value is not nil.
func (dc *DirectoryCreate) SetNillableMetadata(s *string) *DirectoryCreate {
	if s != nil {
		dc.SetMetadata(*s)
	}
	return dc
...
func (dc *DirectoryCreate) SetIsRoot(b bool) *DirectoryCreate {
	dc.mutation.SetIsRoot(b)
	return dc
}

// SetNillableIsRoot sets the "is_root" field if the given value is not nil.
func (dc *DirectoryCreate) SetNillableIsRoot(b *bool) *DirectoryCreate {
	if b != nil {
		dc.SetIsRoot(*b)
	}
	return dc
...
func (dc *DirectoryCreate) defaults() error {
	if _, ok := dc.mutation.CreatedAt(); !ok {
		if directory.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized directory.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := directory.DefaultCreatedAt()
		dc.mutation.SetCreatedAt(v)
	}
	if _, ok := dc.mutation.UpdatedAt(); !ok {
		if directory.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized directory.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := directory.DefaultUpdatedAt()
		dc.mutation.SetUpdatedAt(v)
	}
	if _, ok := dc.mutation.IsRoot(); !ok {
		v := directory.DefaultIsRoot
		dc.mutation.SetIsRoot(v)
	}
	return nil
}
...
func (dc *DirectoryCreate) check() error {
	...
	if _, ok := dc.mutation.IsRoot(); !ok {
		return &ValidationError{Name: "is_root", err: errors.New(`ent: missing required field "Directory.is_root"`)}
	}
	return nil
}
...
func (dc *DirectoryCreate) createSpec() (*Directory, *sqlgraph.CreateSpec) {
	...
	if value, ok := dc.mutation.IsRoot(); ok {
		_spec.SetField(directory.FieldIsRoot, field.TypeBool, value)
		_node.IsRoot = value
	}
